"""
   ...
   Referred from http://chrome-extension-downloader.com/how-does-it-work.php
	Taken from: https://gist.github.com/luizoti/20e41bb0ea30f2ce0170b657e1238499
"""
...
class ChromeExtensionDownloader():
	...
	def download(self, chrome_store_url, user_agent_ver, dest_dir='crxuploads'):
		"""
	...
	def download_file(self, extension_url, dest_dir='crxuploads', file_name=None):
...
def download_crx(url):
	...
	Parameter: String (URL to extension)
   Return: A CRX file in the same directory as download_crx.py.
	"""
