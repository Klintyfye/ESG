...
def search():
    if request.method == 'POST':
        ...
        # extension_name = secure_filename(extension_name)
        # print(extension_name)
        extension_ifo_list = api.autocomplete(extension_name)
        # for i in range(len(extension_ifo_list)):
        #     for j in range(len(extension_ifo_list[i])):
        #         print(extension_ifo_list[i][j])
        #         print("\n")
        print("\n")
        content = extension_ifo_list
